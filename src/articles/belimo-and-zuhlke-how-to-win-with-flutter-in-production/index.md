...
The choice of a local database was more complicated than we expected. Some of the most popular database packages, like Isar and Hive, were abandoned. Others, like Drift and sqflite, were driven by a single contributor. After a proof of concept and a signal from the Flutter community that it will get more contributors, we have decided on Drift. 
