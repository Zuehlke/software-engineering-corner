---
title: >-
  Precision calibration of digital light projectors using the Moiré effect - How
  to unveil the unseen...
description: >-
  Inspired by super-resolution microscopy: harnessing the Moiré effect for
  precision alignment and calibration of digital light projectors
released: '2025-06-23T09:28:20.499Z'
cover: images/cover.jpg
author: Stefan Geissbühler
tags:
  - optics
  - projector
  - calibration
...
shortDescription: >-
  Discover how the Moiré effect enables precise calibration of digital light
  projectors, overcoming resolution limits for real-time alignment and quality
  assessment.
---
import aliasingArtifact from './images/A_ayVSasV.png';
import moireePatternFormation from './images/s9sqZls-Y.png';
import projector from './images/hGci_92HS.png';
...
<figure>
<img src={aliasingArtifact.src}
         alt="aliasing artifact" />
<figcaption>
  Simulated image of a patterned textile that interferes with the sampling grid of an image sensor: The image to the left illustrates the effect of a lacking anti-aliasing filter and the image to the right shows the corresponding image with anti-aliasing filter
</figcaption>
</figure>
...
<figure>
<img src={moireePatternFormation.src}
